        ...
        <div className="container py-4">
            <div className="row gy-4 gx-5">
                <div className="col-lg-4 col-md-6">
                    ...
                    <p className="small text-muted">Dhiraj Bari- Computer Science VIT, Pune. Implementation of Blockchain and Peer-to-Peer
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <ul className="small text-muted"><h6>
                        <li className="small text-muted"><a href="https://github.com/dhiraj0911" className="link-dark"  target="_blank" rel="noreferrer">Github</a></li>
                        <br></br>        
                        <li className="small text-muted"><a href="https://twitter.com/dhiru9bari" className="link-dark" target="_blank" rel="noreferrer">Twitter</a></li>
                        <br></br>        
                        <li className="small text-muted"><a href="https://www.linkedin.com/in/dhiraj-bari-a37b8120a/" className="link-dark" target="_blank" rel="noreferrer">LinkedIn</a></li>
                        </h6>      
                    </ul>
                </div>
